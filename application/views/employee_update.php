			  <div class="panel-body">
					<form action="" id="inputform" method="post" class="form-horizontal">
					  <fieldset>
						...
						<div class="col-sm-10">		
						<input class="form-control" id="name" type="text" name="name" value="<?php echo $item->EMPLOYEE_NAME;?>" placeholder="Employee Name" required>
						</div>
						</div>
						<div class="form-group">	
						<label for="email" class="col-sm-2">Employee Email:<br></label>
						<div class="col-sm-10">		
						<input class="form-control" id="email" type="email" name="email" value="<?php echo $item->EMPLOYEE_EMAIL;?>" placeholder="Employee Email" required>
						</div>
						</div>
						<div class="form-group">	
						<label for="phone" class="col-sm-2">Employee Phone:<br></label>
						<div class="col-sm-10">		
						<input class="form-control" id="phone" type="text" name="phone" value="<?php echo $item->EMPLOYEE_PHONE;?>" placeholder="Employee Phone">
						</div>
						</div>										
