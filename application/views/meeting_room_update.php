			  <div class="panel-body">
					<form action="" id="inputform" method="post" class="form-horizontal">
					  <fieldset>
						...
						<label for="name" class="col-sm-2">Meeting Room Name:<br></label>
						<div class="col-sm-10">		
						<input class="form-control" id="name" type="text" name="name" value="<?php echo $item->ROOM_NAME;?>" placeholder="Meeting Room Name" required>
						</div>
						</div>
