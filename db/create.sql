...
INSERT INTO `smoff`.`ROLE` (`ID`, `ROLE_NAME`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (DEFAULT, 'Host', DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `smoff`;
INSERT INTO `smoff`.`INIT_DATA` (`ID`, `APP_NAME`, `OFFICE_NAME`, `ICON`, `THEME`, `FRONT_ICON`, `FRONT_PAGE`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `FILE_ID`) VALUES (DEFAULT, 'Visitor Management', 'Demo Inc', 'envelope', 'dark', 'quora', 'demo', DEFAULT, DEFAULT, 4, NULL);
