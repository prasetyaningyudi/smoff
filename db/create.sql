...
START TRANSACTION;
USE `bukn1459_guestbook`;
INSERT INTO `bukn1459_guestbook`.`COMPANY` (`ID`, `COMPANY_NAME`, `COMPANY_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `REF_GENERAL_ID`) VALUES (DEFAULT, 'No Company', '1', DEFAULT, DEFAULT, 1, 2);
...
START TRANSACTION;
USE `bukn1459_guestbook`;
INSERT INTO `bukn1459_guestbook`.`DIVISION` (`ID`, `DIVISION_NAME`, `DIVISION_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `DIVISION_TOP_ID`, `USER_ID`) VALUES (DEFAULT, 'Head Division', DEFAULT, DEFAULT, DEFAULT, NULL, DEFAULT);
INSERT INTO `bukn1459_guestbook`.`DIVISION` (`ID`, `DIVISION_NAME`, `DIVISION_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `DIVISION_TOP_ID`, `USER_ID`) VALUES (DEFAULT, 'Second Division', DEFAULT, DEFAULT, DEFAULT, NULL, DEFAULT);
...
START TRANSACTION;
USE `bukn1459_guestbook`;
INSERT INTO `bukn1459_guestbook`.`EMPLOYEES` (`ID`, `EMPLOYEE_NAME`, `EMPLOYEE_EMAIL`, `EMPLOYEE_PHONE`, `EMPLOYEE_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `EMPLOYEES_TOP_ID`, `DIVISION_ID`, `FILE_ID`) VALUES (DEFAULT, 'Yudi Prasetyo', 'prasetyaningyudi@gmail.com', '081329680342', '1', DEFAULT, DEFAULT, 1, NULL, NULL, NULL);
INSERT INTO `bukn1459_guestbook`.`EMPLOYEES` (`ID`, `EMPLOYEE_NAME`, `EMPLOYEE_EMAIL`, `EMPLOYEE_PHONE`, `EMPLOYEE_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `EMPLOYEES_TOP_ID`, `DIVISION_ID`, `FILE_ID`) VALUES (DEFAULT, 'Hafiz Adnan', 'hafidz.adnan@gmail.com', '088229922002', '1', DEFAULT, DEFAULT, 1, NULL, NULL, NULL);
INSERT INTO `bukn1459_guestbook`.`EMPLOYEES` (`ID`, `EMPLOYEE_NAME`, `EMPLOYEE_EMAIL`, `EMPLOYEE_PHONE`, `EMPLOYEE_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `EMPLOYEES_TOP_ID`, `DIVISION_ID`, `FILE_ID`) VALUES (DEFAULT, 'John doe', 'john.doe@gmail.com', '080282828288', '1', DEFAULT, DEFAULT, 4, NULL, NULL, NULL);
INSERT INTO `bukn1459_guestbook`.`EMPLOYEES` (`ID`, `EMPLOYEE_NAME`, `EMPLOYEE_EMAIL`, `EMPLOYEE_PHONE`, `EMPLOYEE_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `EMPLOYEES_TOP_ID`, `DIVISION_ID`, `FILE_ID`) VALUES (DEFAULT, 'Marry Jean', 'marry.jane@gmail.com', '039393939399', '0', DEFAULT, DEFAULT, 4, NULL, NULL, NULL);
...
START TRANSACTION;
USE `bukn1459_guestbook`;
INSERT INTO `bukn1459_guestbook`.`MEETING_ROOM` (`ID`, `ROOM_NAME`, `ROOM_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`) VALUES (DEFAULT, 'Room 1', DEFAULT, DEFAULT, DEFAULT, 1);
